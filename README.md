...
- Backend order, position, alert, and audit `GET` endpoints atomically project validated durable
  saved-workflow simulation executions; without one, they remain visibly representative.
