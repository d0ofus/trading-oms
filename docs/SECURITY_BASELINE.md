...
simulation and paper-mode risk-increasing work.
...
Controlled rollout, observability, backup/restore tooling, incident response, and live-readiness
evidence remain later approved work.
